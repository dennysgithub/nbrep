...
Det går dessutom rykten i SEO-branschen att Google i framtiden kommer börja ta betalt för att låta företag utnyttja tjänsten, vilket inte vore helt orimligt, så jag rekommenderar att du utnyttjar Google My Business till fullo genom att optimera din profil så bra som du förmår.
...
*(exempel på Googles 3-pack inrutat i grönt nedan)*
![Google-My-Business-3-pack](/images/post/3-pack.png)

**<span style="font-size:25px;">Intro</span>**  
Den här guiden är tänkt att ge grundläggande kunskaper i hur man optimerar Google My Business och är inte tänkt att avse avancerade strategier eller stora mängder detaljer. Förhoppningen är att guiden kommer ge den "gemene företagaren" som vill göra det här på egen hand kött på benen och i slutändan gå härifrån med en klart förbättrad profil och snart därefter fler kunder.
<br></br>
...
*(obs: i exemplet nedan skapar jag ett nytt företag, om ditt företag dyker upp så väljer du det)*  
...
Eftersom "advokatbyrå" **beskriver din verksamhet i helhet bäst så ska detta vara din primära kategori.** Men jag rekommenderar dig att också välja *"familjerätt", "brottmål" och "socialrätt"* som underkategorier **för då kommer du dyka upp i Google även för dessa söktermer = fler kunder.**
...
> **OBS!** Byt **INTE** ut rabatter eller dylikt mot recensioner. <mark>**Detta är strikt förbjudet enligt Google**</mark> och du riskerar att inte bara förlora alla dina recensioner om de kommer på dig utan även hela profilen. 
...
***OBS:** Det är emot Googles riktlinjer att inkludera PR i form av rabatter och länkar i beskrivningen. Du får dock inkludera telefonnummer och epostadress.* 
