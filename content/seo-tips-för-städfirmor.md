...
Är det något som verkade oklart, något ni vill ha hjälp med

Det var allt för denna gången. Jag försökte hålla det så kort som möjligt så det var en del som inte kom med alls så som nyckelords-optimering, HTML taggar och liknande. Men det här är en bra start för att fixa till lite på egen hand. 

Vill du inte fixa till på egen hand så bistår jag som vanligt med hjälp. Kontakta mig via chatten eller [kontaktformuläret ](https://www.nordbergmedia.se/kontakt "kontaktformuläret")så tar vi ett snack. 