...
_Nedan visar jag så simpelt det går hur du gör detta manuellt men jag rekommenderar ändå att läsa på_ <a href="[https://schema.org/](https://schema.org/ "https://schema.org/")" target="_blank">schema.org</a> _för en bättre förståelse om strukturerad data och dess möjligheter._
...
Vill du inte fixa till på egen hand så bistår jag som vanligt med hjälp. Kontakta mig via chatten eller [kontaktformuläret ](https://www.nordbergmedia.se/kontakt "kontaktformuläret")så snackar vi!